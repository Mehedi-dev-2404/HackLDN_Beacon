...
export default function OpportunityCard({ opportunity, onApply }) {
  ...
  return (
    <div 
      ...
      className={`border p-6 hover:shadow-lg hover:shadow-white/5 transition-all group animate-fade-in cursor-pointer font-mono
    ...
    >
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center gap-2 text-white hover:gap-3 transition-all text-sm font-mono"
        >
          {actionText}
          <span>→</span>
        </button>
