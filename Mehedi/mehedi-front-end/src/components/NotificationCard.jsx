...
export default function NotificationCard({ notification, onAction, onDismiss }) {
  ...
  const getUrgencyColor = (urgency) => {
    switch (urgency) {
      case 'high': return 'text-red-400 animate-pulse-ultra';
      case 'medium': return 'text-yellow-400 animate-glow-yellow';
  ...
  return (
    <section className="animate-fade-in mb-8">
      <div className="border border-gray-700 p-6 relative animate-border-glow">
        ...
        <div className="text-lg leading-relaxed mb-6 pl-4 border-l-2 border-gray-700">
        ...
        <div className="flex gap-4">
          <button
            onClick={onAction}
            className="px-6 py-2 border border-white text-sm hover:bg-white hover:text-black transition-all font-mono"
          >
            [ Take Action ]
          </button>
          <button
            onClick={handleDismiss}
            className="px-6 py-2 border border-gray-700 text-sm text-gray-400 hover:border-gray-500 hover:text-white transition-all font-mono"
          >
            [ Dismiss ]
          </button>
        </div>
