...
def _validate_settings(settings: Settings) -> None:
    ...
    if not settings.frontend_base_url.strip():
        errors.append("FRONTEND_BASE_URL cannot be blank")
    elif urlparse(settings.frontend_base_url).scheme not in {"http", "https"}:
        errors.append("FRONTEND_BASE_URL must use http:// or https://")
